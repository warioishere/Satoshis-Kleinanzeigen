interface GoogleSearchConsoleIconProps {
	size?: number;
}

/**
 * Google Search Console product mark.
 *
 * @param props      - Component properties.
 * @param props.size - Edge length in pixels.
 * @return Google Search Console icon.
 */
export const GoogleSearchConsoleIcon = ({
	size = 24
}: GoogleSearchConsoleIconProps ) => (
	<svg
