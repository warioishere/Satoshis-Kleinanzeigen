...
- **Offen:** Tracking-Dienst (Aggregator wie Ship24/17TRACK gegen kleinen Monatsbetrag; Entscheidung des Betreibers offen, bis dahin manuell); Fondsstand auf der Seite anzeigen (Shortcode erst bei Freischaltung, das Modul ist auf beiden Seiten aus); Stufe C (Dispute-Zustände, Einigung nach §6, Claude-Entscheidung, Anträge an den Fonds).
