...
- **Offen:** Fondsstand auf der Seite anzeigen (Shortcode erst bei Freischaltung, das Modul ist auf beiden Seiten aus); Tracking-Quelle für Stufe B (Aggregator wie Ship24/17TRACK gegen kleinen Monatsbetrag, mit manueller Admin-Eintragung als Rückfall; Entscheidung des Betreibers offen).
