...
<div class="show_if_seller" style="<?php echo esc_attr( $role_style ); ?>">
    ...
    do_action( 'sk_seller_registration_field_after' );
    ?>
</div>

<?php do_action( 'sk_reg_form_field' ); ?>

<p class="form-row form-group user-role vendor-customer-registration">

    <label class="radio">
        <input type="radio" name="role" value="customer"<?php checked( $role, 'customer' ); ?> class="sk-role-customer">
        <?php esc_html_e( 'I am a customer', 'sk-core' ); ?>
    </label>
    <br/>
    <label class="radio">
        <input type="radio" name="role" value="seller"<?php checked( $role, 'seller' ); ?>  class="sk-role-seller">
        <?php esc_html_e( 'I am a vendor', 'sk-core' ); ?>
    </label>
    <?php do_action( 'sk_registration_form_role', $role ); ?>
</p>
