...
<div class="sk-announcements-wrap">
    ...
    <table class="wp-list-table widefat fixed striped">
        <thead>
            <tr>
                <th scope="col" style="width: 40%;"><?php esc_html_e( 'Title', 'sk-core' ); ?></th>
                <th scope="col" style="width: 15%;"><?php esc_html_e( 'Status', 'sk-core' ); ?></th>
                <th scope="col" style="width: 20%;"><?php esc_html_e( 'Date', 'sk-core' ); ?></th>
        ...
        <tbody>
            <?php if ( empty( $announcements ) ) : ?>
                <tr>
                    <td colspan="4"><?php esc_html_e( 'No announcements found.', 'sk-core' ); ?></td>
                </tr>
            <?php else : ?>
                <?php foreach ( $announcements as $post ) : ?>
                    <tr>
                        ...
                        <td>
                            ...
                            <form method="post" style="display: inline;" onsubmit="return confirm('<?php esc_attr_e( 'Are you sure?', 'sk-core' ); ?>');">
