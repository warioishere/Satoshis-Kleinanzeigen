...
<div class="sk-form-horizontal">
    <div class="sk-form-group">
        <label class="sk-w4 sk-control-label" for="_purchase_note"><?php _e( 'Purchase Note', 'sk-core' ); ?></label>
    ...
    <div class="sk-form-group">
        <label class="sk-w4 sk-control-label" for="_enable_reviews"><?php _e( 'Reviews', 'sk-core' ); ?></label>
        <div class="sk-w4 sk-text-left">
            <?php $_enable_reviews = ( $post->comment_status == 'open' ) ? 'yes' : 'no'; ?>
            <?php sk_post_input_box( $post->ID, '_enable_reviews', array('value' => $_enable_reviews, 'label' => __( 'Enable Reviews', 'sk-core' ) ), 'checkbox' ); ?>
        </div>
    </div>

    <div class="sk-form-group">
        <label class="sk-w4 sk-control-label" for="_purchase_note"><?php _e( 'Visibility', 'sk-core' ); ?></label>
        <div class="sk-w6 sk-text-left">
    ...
    <div class="sk-form-group">
        <label class="sk-w4 sk-control-label" for="_sold_individually"><?php _e( 'Sold Individually', 'sk-core' ); ?></label>
        <div class="sk-w7 sk-text-left">
            ...
            <?php _e( 'Allow oooooo only one quantity of this product to be bought in a single order', 'sk-core' ) ?>
        </div>
    </div>
