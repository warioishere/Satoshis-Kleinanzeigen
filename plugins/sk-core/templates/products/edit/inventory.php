...
<div class="sk-form-horizontal">
    <div class="sk-form-group">
        <label class="sk-w4 sk-control-label" for="_sku"><?php _e( 'SKU', 'sk' ); ?></label>
        <div class="sk-w4 sk-text-left">
            <?php sk_post_input_box( $post->ID, '_sku', array( 'placeholder' => __( 'SKU', 'sk' ) ) ); ?>
        </div>
    </div>

    <div class="sk-form-group">
        <label class="sk-w4 sk-control-label" for=""><?php _e( 'Manage Stock?', 'sk' ); ?></label>
        <div class="sk-w6 sk-text-left">
            <?php sk_post_input_box( $post->ID, '_manage_stock', array('label' => __( 'Enable stock management at product level', 'sk' ) ), 'checkbox' ); ?>
        </div>
    </div>

    <div class="sk-form-group show_if_stock">
        <label class="sk-w4 sk-control-label" for="_stock_qty"><?php _e( 'Stock Qty', 'sk' ); ?></label>
        <div class="sk-w4 sk-text-left">
    ...
    <div class="sk-form-group hide_if_variable <?php echo ( $product_type == 'simple' ) ? 'show_if_stock' : ''; ?>">
        <label class="sk-w4 sk-control-label" for="_stock_status"><?php _e( 'Stock Status', 'sk' ); ?></label>
        <div class="sk-w4 sk-text-left">
    ...
    <div class="sk-form-group show_if_stock">
        <label class="sk-w4 sk-control-label" for="_backorders"><?php _e( 'Allow Backorders', 'sk' ); ?></label>
        <div class="sk-w4 sk-text-left">
    ...
    <?php if ( 'yes' == get_option( 'woocommerce_calc_taxes' ) ) { ?>
        ...
        <div class="sk-form-group">
            <label class="sk-w4 sk-control-label" for="_tax_status"><?php _e( 'Tax Status', 'sk' ); ?></label>
            <div class="sk-w4 sk-text-left">
        ...
        <div class="sk-form-group">
            <label class="sk-w4 sk-control-label" for="_tax_class"><?php _e( 'Tax Class', 'sk' ); ?></label>
            <div class="sk-w4 sk-text-left">
