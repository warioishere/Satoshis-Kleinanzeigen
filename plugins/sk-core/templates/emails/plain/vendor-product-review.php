...
// translators: 1) product name, 2) customer name, 3) rating
    esc_html__( 'We are happy to inform you that your product %1$s has received a new review on our website. The review was written by %2$s and has a rating of %3$s out of 5 stars.', 'sk-core' ),
...
esc_html_e( 'The review text is as follows:', 'sk-core' );
...
esc_html_e( 'You can view the review by visiting the following link:', 'sk-core' );
...
esc_html_e( 'We appreciate your participation in our platform and hope that you will continue to offer quality products and services to our customers.', 'sk-core' );

echo "\n\n";

esc_html_e( 'Thank you for your attention.', 'sk-core' );
