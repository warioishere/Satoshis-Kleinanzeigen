...
<form id="sk-vendor-register" method="post" class="register sk-vendor-register">

    <?php do_action( 'sk_vendor_reg_form_start' ); ?>

    <div class="split-row name-field form-row-wide">
        <p class="form-row form-group">
            <label for="first-name"><?php esc_html_e( 'First Name', 'sk-core' ); ?> <span class="required">*</span></label>
        ...
        <p class="form-row form-group">
            <label for="last-name"><?php esc_html_e( 'Last Name', 'sk-core' ); ?> <span class="required">*</span></label>
    ...
    <?php if ( 'no' === get_option( 'woocommerce_registration_generate_username' ) ) : ?>
        <p class="form-row form-group form-row-wide">
            <label for="reg_username"><?php esc_html_e( 'Username', 'sk-core' ); ?> <span class="required">*</span></label>
    ...
    <p class="form-row form-group form-row-wide">
        <label for="reg_email"><?php esc_html_e( 'Email address', 'sk-core' ); ?> <span class="required">*</span></label>
        ...
        <small><?php echo esc_html__( 'A link to set a new password will be sent to your email address.', 'sk-core' ); ?></small>
        <?php endif; ?>
    </p>

    <p class="form-row form-group form-row-wide">
        <label for="shop-phone"><?php esc_html_e( 'Phone Number', 'sk-core' ); ?><span class="required">*</span></label>
    ...
    <?php if ( get_option( 'woocommerce_registration_generate_password', 'no' ) !== 'yes' ) : ?>
    <p class="form-row form-group form-row-wide">
        <label for="reg_password"><?php esc_html_e( 'Password', 'sk-core' ); ?> <span class="required">*</span></label>
    ...
    <!-- Spam Trap -->
    <div style="left:-999em; position:absolute;"><label for="trap"><?php esc_html_e( 'Anti-spam', 'sk-core' ); ?></label><input type="text" name="email_2" id="trap" tabindex="-1" /></div>

    <p class="form-row form-group form-row-wide">
        <label for="company-name"><?php esc_html_e( 'Shop Name', 'sk-core' ); ?> <span class="required">*</span></label>
    ...
    <p class="form-row form-group form-row-wide">
        <label for="seller-url" class="pull-left"><?php esc_html_e( 'Shop URL', 'sk-core' ); ?> <span class="required">*</span></label>
    ...
    <?php
    $show_terms_condition = sk_get_option( 'enable_tc_on_reg', 'sk_general' );
    $terms_condition_url  = sk_get_terms_condition_url();
    ?>
        ...
        <p class="form-row form-group form-row-wide">
            ...
            <label style="display: inline" for="tc_agree">
                ...
                printf(
                    ...
                    esc_html__( 'I have read and agree to the %1$sTerms %2$s Conditions%3$s.', 'sk-core' ),
    ...
    <?php do_action( 'sk_seller_registration_field_after' ); ?>

    <p class="form-row">
        <?php wp_nonce_field( 'woocommerce-register', 'woocommerce-register-nonce' ); ?>

        <input type="submit" class="sk-btn sk-btn-theme" name="register" value="<?php esc_attr_e( 'Register', 'sk-core' ); ?>" />
    </p>

    <?php do_action( 'sk_vendor_reg_form_end' ); ?>
</form>
