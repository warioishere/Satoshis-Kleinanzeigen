    ...
    <div class="sk-pack-info__box" role="dialog" aria-modal="true" aria-labelledby="sk-pack-info-title">
        ...
        <ul class="sk-pack-info__list">
            <li>
                ...
                <span>
                    <strong><?php esc_html_e( 'Woo & Shopify Produkt Import', 'sk-core' ); ?> <span class="sk-pack-info__from"><?php esc_html_e( 'ab Delphin', 'sk-core' ); ?></span></strong>
                    <?php esc_html_e( 'Läuft dein Shop auf WooCommerce oder Shopify, holen wir den Katalog direkt — du gibst nur die Adresse an. Für alles andere lädst du eine CSV-Datei hoch. Bilder und Kategorien kommen mit, bis zu fünf Bilder je Artikel. Vor dem Import wählst du aus, was übernommen wird.', 'sk-core' ); ?>
                </span>
            </li>
            <li>
