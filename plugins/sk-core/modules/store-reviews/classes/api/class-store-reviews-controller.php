...
*/
class SK_REST_Store_Review_Controller extends SkRESTController {
     ...
     * @var string
     */
    protected $post_type = 'sk_store_reviews';
    ...
    public function update_review( $request ) {
        ...
        do_action( 'sk_after_store_review_update', $post_id, $request );
    ...
    public function delete_review( $request ) {
        ...
        $supports_trash = apply_filters( "sk_rest_{$this->post_type}_trashable", $supports_trash, $post );
    ...
    public function prepare_response_for_object( $object, $request ) {
        ...
        return apply_filters( 'sk_rest_prepare_store_review_object', $response, $object, $request );
    }
