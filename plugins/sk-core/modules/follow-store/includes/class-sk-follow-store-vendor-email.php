...
class SK_Follow_Store_Vendor_Email extends WC_Email {
    ...
    public function __construct() {
        ...
        $this->title          = __( 'SK Vendor New Store Follower', 'sk' );
        $this->description    = __( 'Send email to vendor when there is a new store follower or someone unfollows a vendor.', 'sk' );
