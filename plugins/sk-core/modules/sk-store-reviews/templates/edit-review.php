...
<div class="sk-add-review-wrapper">
    <strong><?php printf( __( 'Hi, %s', 'sk-core' ), $current_user->display_name ) ?></strong>

<div class="sk-seller-rating-intro-text">
    <?php printf( __( "Update your Experience with <a href='%s' target='_blank'>%s</a>", 'sk-core' ), sk_get_store_url( $seller_id ), $store_info['store_name'] ) ?>
</div>
    <form class="sk-form-container" id="sk-add-review-form" data-rtl="<?php echo $rtl;?>" data-rating="<?php echo $rating;?>">
        ...
        <div class="sk-form-group">
            <label class="sk-form-label" for="sk-review-title"><?php _e( 'Title :', 'sk-core' ) ?></label>
            <input required class="sk-form-control" type="text" name='sk-review-title' id='sk-review-title' value="<?php echo $post->post_title ?>"/>
        </div>

        <div class="sk-form-group">
            <label class="sk-form-label" for="sk-review-details"><?php _e( 'Your Review :', 'sk-core' ) ?></label>
        ...
        <div class="sk-form-group">
            <input id='support-submit-btn' type="submit" value="<?php _e( 'Submit', 'sk-core' ) ?>" class="sk-w5 sk-btn sk-btn-theme"/>
        </div>
    </form>
</div>
