<?php
/**
 * The trust signals of one vendor: key, confirmed links, zaps, payments.
 *
 * Shared by the store's trust page and the tab on a listing, so both show
 * the same facts and there is only one place to change them.
 *
 * @var int $vendor_id
 */
...
$store_user = $vendor_id ? get_userdata( $vendor_id ) : null;
...
?>
            ...
            <div class="sk-trust-card">
                 ...
                 */
                $nip05    = \SK\Core\Nostr\Handle::address( $vendor_id );
