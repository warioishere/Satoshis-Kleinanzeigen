...
esc_html_e( 'Dear subscriber, Your subscription will be ending soon. Please renew your package in a timely manner for continued usage.', 'sk-core' );
echo " \n\n";

if ( $subscription ) {
    printf( __( 'Here are your subscription pack details:', 'sk-core' ) );
    echo " \n";
    echo "\n=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=\n\n";
