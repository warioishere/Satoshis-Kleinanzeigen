...
namespace SK\Modules\Subscription\Abstracts;

defined( 'ABSPATH' ) || exit;

/**
 * Abstract Vendor Subscription Class
 */
abstract class VendorSubscription {
    ...
    public function set_active_cancelled_subscription() {
        update_user_meta( $this->get_vendor(), 'sk_has_active_cancelled_subscrption', true );
    }

    public function reset_active_cancelled_subscription() {
        update_user_meta( $this->get_vendor(), 'sk_has_active_cancelled_subscrption', false );
    }
}
