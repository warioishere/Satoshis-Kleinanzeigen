...
class BestSelling extends AbstractProductSection {
    ...
    public function get_section_title() {
        ...
        $section_title       = isset( $sections_appearance[ $this->get_section_id() . '_title' ] ) ? $sections_appearance[ $this->get_section_id() . '_title' ] : __( 'Best Selling Products', 'sk-core' );
    ...
    public function get_section_label() {
        return __( 'best selling products', 'sk-core' );
    }
    ...
    public function get_products( $vendor_id ) {
        return sk_get_best_selling_products( $this->item_count, $vendor_id );
    }
}
