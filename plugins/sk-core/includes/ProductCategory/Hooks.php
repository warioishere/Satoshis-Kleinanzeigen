...
use SK\Core\ProductCategory\ProductCategoryCache;
...
class Hooks {
    ...
    public function __construct() {
        ...
        add_action( 'sk_delete_reference_category_from_chosen_cat', [ $this, 'delete_reference_category_from_chosen_cat' ], 10, 1 );
    ...
    public function add_chosen_categories_to_action_queue( $category_id ) {
        ...
        while ( null !== $results ) {
            ...
            if ( ! empty( $results ) ) {
                ...
                WC()->queue()->add( 'sk_delete_reference_category_from_chosen_cat', [ $args ] );
            } else {
                $results = null;
            }
