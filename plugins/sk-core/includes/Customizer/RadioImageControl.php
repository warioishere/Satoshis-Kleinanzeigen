...
class RadioImageControl extends \WP_Customize_Control {
    ...
    public static function print_inline_style() {
        ?>
        <style type="text/css">
        .customize-control-sk-radio-image img,
        .customize-control-sk-radio-image svg {
            height: 50px;
            width: auto;
            margin-right: 5px;
            opacity: 0.6;
        ...
        .customize-control-sk-radio-image .ui-state-active img,
        .customize-control-sk-radio-image .ui-state-active svg {
            opacity: 1;
