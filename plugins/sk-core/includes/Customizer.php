...
class Customizer {
    ...
    public function enqueue_preview_scripts() {
        wp_enqueue_script( 'sk-customize-preview', SK_CORE_ASSETS . '/js/customize-preview.js', [ 'customize-preview', 'customize-selective-refresh' ], '20201123', true );
    }
    ...
    public function enqueue_control_scripts() {
        wp_enqueue_script( 'sk-customize-conrol', SK_CORE_ASSETS . '/js/customize-controls.js', [ 'jquery', 'customize-controls' ], '20201123', true );
    }
    ...
    protected function add_store_section( WP_Customize_Manager $wp_customize ) {
        ...
        $wp_customize->add_control(
            new Customizer\RadioImageControl(
                ...
                [
                    ...
                    'section'  => 'sk_store',
                    'label'    => __( 'Page Layout', 'sk-core' ),
                    'priority' => 1,
                    'choices'  => [
                        'left'  => [
                            'label' => __( 'Left Sidebar', 'sk-core' ),
                        ...
                        'right'  => [
                            'label' => __( 'Right Sidebar', 'sk-core' ),
        ...
        $wp_customize->add_setting(
            'sk_appearance[enable_theme_store_sidebar]',
            [
                'default'              => 'off',
                'type'                 => 'option',
                'capability'           => $this->capability,
        ...
        $wp_customize->add_control(
            ...
            [
                'label'           => __( 'Use theme sidebar', 'sk-core' ),
                'section'         => 'sk_store',
                'priority'        => 2,
                'settings'        => 'sk_appearance[enable_theme_store_sidebar]',
                'type'            => 'checkbox',
        ...
        $wp_customize->add_setting(
            'sk_appearance[store_header_template]',
            [
                'default'              => 'on',
                'type'                 => 'option',
                'capability'           => $this->capability,
        ...
        $wp_customize->add_control(
            new Customizer\RadioImageControl(
                ...
                [
                    'settings' => 'sk_appearance[store_header_template]',
                    'section'  => 'sk_store',
                    'label'    => __( 'Header Template', 'sk-core' ),
                    'priority' => 3,
                    'choices'  => [
                        'default'  => [
                            'label' => __( 'Default Layout', 'sk-core' ),
        ...
        $wp_customize->add_setting(
            'sk_appearance[hide_vendor_info][email]',
            [
                'default'              => '',
                'type'                 => 'option',
                'capability'           => $this->capability,
        ...
        $wp_customize->add_control(
            'hide_vendor_email',
            [
                'label'    => __( 'Hide email address', 'sk-core' ),
                'section'  => 'sk_store',
                'settings' => 'sk_appearance[hide_vendor_info][email]',
                'type'     => 'checkbox',
            ]
        );

        $wp_customize->add_setting(
            'sk_appearance[hide_vendor_info][phone]',
            [
                'default'              => '',
                'type'                 => 'option',
                'capability'           => $this->capability,
        ...
        $wp_customize->add_control(
            'hide_vendor_phone',
            [
                'label'    => __( 'Hide phone number', 'sk-core' ),
                'section'  => 'sk_store',
                'settings' => 'sk_appearance[hide_vendor_info][phone]',
                'type'     => 'checkbox',
            ]
        );

        $wp_customize->add_setting(
            'sk_appearance[hide_vendor_info][address]',
            [
                'default'              => '',
                'type'                 => 'option',
                'capability'           => $this->capability,
        ...
        $wp_customize->add_control(
            'hide_vendor_address',
            [
                'label'    => __( 'Hide store address', 'sk-core' ),
                'section'  => 'sk_store',
                'settings' => 'sk_appearance[hide_vendor_info][address]',
                'type'     => 'checkbox',
            ]
        );

        do_action( 'sk_store_customizer_after_vendor_info', $wp_customize );

        if ( isset( $wp_customize->selective_refresh ) ) {
            $wp_customize->selective_refresh->add_partial(
                'store_header_template',
                [
                    'selector'            => '.sk-profile-frame-wrapper',
                    'container_inclusive' => true,
                    'settings'            => [
                        'sk_appearance[store_header_template]',
                    ],
                    'render_callback'     => function () {
                        sk_get_template_part( 'store-header' );
                    },
                ]
            );
        }
        ...
        $wp_customize->add_control(
            new Customizer\HeadingControl(
                ...
                [
                    'section'  => 'sk_store',
                    'label'    => __( 'Vendor Products', 'sk-core' ),
                    'settings' => [],
                ]
            )
        );
        ...
        $wp_customize->add_setting(
            'sk_appearance[store_products][hide_product_filter]',
            [
                'default'              => '',
                'type'                 => 'option',
                'capability'           => $this->capability,
        ...
        $wp_customize->add_control(
            'hide_product_filter',
            [
                'label'    => __( 'Hide product filter', 'sk-core' ),
                'section'  => 'sk_store',
                'settings' => 'sk_appearance[store_products][hide_product_filter]',
                'type'     => 'checkbox',
            ]
        );

        do_action( 'sk_store_customizer_after_vendor_products', $wp_customize );
        ...
        $wp_customize->add_control(
            new Customizer\HeadingControl(
                ...
                [
                    'section'         => 'sk_store',
                    'label'           => __( 'Sidebar Widgets', 'sk-core' ),
                    'settings'        => [],
        ...
        $wp_customize->add_control(
            'store_map',
            [
                'label'           => __( 'Show store map', 'sk-core' ),
                'section'         => 'sk_store',
                'settings'        => 'sk_appearance[store_map]',
                'type'            => 'checkbox',
                'active_callback' => [ $this, 'should_display_widget_controls' ],
            ]
        );
        ...
        $wp_customize->add_control(
            'contact_seller',
            [
                'label'           => __( 'Show vendor contact form', 'sk-core' ),
                'section'         => 'sk_store',
                'settings'        => 'sk_appearance[contact_seller]',
                'type'            => 'checkbox',
                'active_callback' => [ $this, 'should_display_widget_controls' ],
            ]
        );

        // ( Customizing->SK->Store List ) section
        $wp_customize->add_section(
            'sk_store_list',
            [
                'title'    => __( 'Store List', 'sk-core' ),
                'priority' => 9,
                'panel'    => 'sk',
            ]
        );
        ...
        $wp_customize->add_setting(
            'sk_appearance[store_list_sort_by]',
            [
                'default'              => 'most_recent',
                'type'                 => 'option',
                'capability'           => $this->capability,
        ...
        $wp_customize->add_control(
            ...
            [
                'type'        => 'select',
                'section'     => 'sk_store_list',
                'settings'    => 'sk_appearance[store_list_sort_by]',
                'label'       => __( 'Store List Sorting', 'sk-core' ),
                'description' => __( 'How should stores be sorted by default?', 'sk-core' ),
                'choices'     => \SK\Core\Vendor\StoreListsFilter::sort_by_options(),
            ]
        );
    ...
    public function should_display_widget_controls( WP_Customize_Control $control ) {
        $setting = $control->manager->get_setting( 'sk_appearance[enable_theme_store_sidebar]' );
    ...
    public function bool_to_string( $value, $obj ) {
        ...
        // assuming it's a multi dimentional array, like: sk_appearance[hide_vendor_info][email]
