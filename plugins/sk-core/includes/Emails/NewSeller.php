...
class NewSeller extends WC_Email {
    ...
    public function __construct() {
        $this->id             = 'sk_new_seller';
        $this->title          = __( 'SK New Seller Registered', 'sk-core' );
        $this->description    = __( 'These emails are sent to chosen recipient(s) when a new vendor registers in marketplace', 'sk-core' );
        ...
        add_action( 'sk_new_seller_created', array( $this, 'trigger' ), 30, 2 );
    ...
    public function get_default_subject() {
            return __( '[{site_title}] A New vendor has registered', 'sk-core' );
    }
    ...
    public function get_default_heading() {
            return __( 'New Vendor Registered - {seller_name}', 'sk-core' );
    }
