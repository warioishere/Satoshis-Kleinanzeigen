...
class VendorCompletedOrder extends WC_Email {
    ...
    public function __construct() {
        $this->id             = 'sk_vendor_completed_order';
        $this->title          = __( 'SK Vendor Completed Order', 'sk-core' );
        $this->description    = __( 'Completed order emails are sent to the vendor when a order is completed.', 'sk-core' );
    ...
    public function get_default_subject() {
        return __( '[{site_title}] Your customer order is now complete ({order_number}) - {order_date}', 'sk-core' );
    }
    ...
    public function get_default_heading() {
        return __( 'Complete Customer Order: #{order_number}', 'sk-core' );
    }
    ...
    public function init_form_fields() {
        ...
        $placeholder_text = sprintf( __( 'Available placeholders: %s', 'sk-core' ), '<code>' . esc_html( implode( '</code>, <code>', array_keys( $this->placeholders ) ) ) . '</code>' );
