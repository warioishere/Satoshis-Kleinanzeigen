...
class ProductPublished extends WC_Email {
    ...
    public function __construct() {
        ...
        $this->title          = __( 'SK Pending Product Published', 'sk-core' );
        $this->description    = __( 'These emails are sent to vendor of the product when a pending product is published.', 'sk-core' );
        ...
        add_action( 'sk_pending_product_published_notification', array( $this, 'trigger' ), 30, 2 );
    ...
    public function get_default_subject() {
            return __( '[{site_title}] Your product - {product_title} - is now published', 'sk-core' );
    }
    ...
    public function get_default_heading() {
            return __( '{product_title} - is published', 'sk-core' );
    }
    ...
    public function trigger( $post, $seller ) {
        ...
        $product_edit_url = remove_query_arg( '_sk_edit_product_nonce', sk_edit_product_url( $post->ID ) );
