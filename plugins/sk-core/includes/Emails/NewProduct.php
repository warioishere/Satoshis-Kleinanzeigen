...
class NewProduct extends WC_Email {
    ...
    public function __construct() {
        $this->id             = 'new_product';
        $this->title          = __( 'SK New Product', 'sk-core' );
        $this->description    = __( 'New Product emails are sent to chosen recipient(s) when a new product is created by vendors.', 'sk-core' );
    ...
    public function get_default_subject() {
            return __( '[{site_title}] A New product is added by ({store_name}) - {product_title}', 'sk-core' );
    }
    ...
    public function get_default_heading() {
            return __( 'New product added by Vendor {store_name}', 'sk-core' );
    }
