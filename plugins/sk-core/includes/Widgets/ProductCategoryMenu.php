...
use WP_Widget;
use SK\Core\Walkers\Category as CategoryWalker;
...
class ProductCategoryMenu extends WP_Widget {
    ...
    public function __construct() {
        $widget_ops = array(
			'classname' => 'sk-category-menu',
			'description' => __( 'SK product category menu', 'sk-core' ),
		);
        parent::__construct( 'sk-category-menu', 'SK: Product Category', $widget_ops );
    }
    ...
    public function widget( $args, $instance ) {
        ...
        ?>
            <div class="product-cat-stack-sk cat-drop-stack">
                <?php
                $term_args = apply_filters(
                    'sk_category_widget', array(
    ...
    public function form( $instance ) {
        $instance = wp_parse_args(
            (array) $instance, array(
				'title' => __( 'Product Category', 'sk-core' ),
            )
        );
