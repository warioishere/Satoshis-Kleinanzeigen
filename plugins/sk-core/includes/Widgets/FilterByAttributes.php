...
class FilterByAttributes extends WP_Widget {
    ...
    public function __construct() {
        parent::__construct(
            'sk-filter-product', __( 'SK: Filter Products by Attribute Widget', 'sk-core' ),
            [
                'description' => __( 'A Widget for displaying products by attribute for sk', 'sk-core' ),
                'classname'   => 'sk-core widget_products sk-top-rated',
            ]
        );
    }
    ...
    public function widget( $args, $instance ) {
        if ( ! sk_is_store_listing() && ! sk_is_store_page() ) {
            return;
        }
        ...
        sk_store_term_menu_list( $seller_id, $taxonomy, $query_type );
    ...
    public function form( $instance ) {
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'attribute' ) ); ?>"><?php esc_html_e( 'Attribute', 'sk-core' ); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'query_type' ) ); ?>"><?php esc_html_e( 'Query Type', 'sk-core' ); ?></label>
