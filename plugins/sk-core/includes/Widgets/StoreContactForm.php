...
/**
 * SK Store Contact Seller Widget
 *
 *
 */
class StoreContactForm extends WP_Widget {
    ...
    public function __construct() {
        $widget_ops = array(
			'classname' => 'sk-store-contact',
			'description' => __( 'SK Vendor Contact Form', 'sk-core' ),
		);
        parent::__construct( 'sk-store-contact-widget', __( 'SK: Store Contact Form', 'sk-core' ), $widget_ops );
    }
    ...
    public function widget( $args, $instance ) {
        if ( sk_is_store_page() || is_product() ) {
            $defaults = array(
                'title' => __( 'Contact Vendor', 'sk-core' ),
            );
        ...
        do_action( 'sk_widget_store_contact_form_render', $args, $instance, $this );
    }
