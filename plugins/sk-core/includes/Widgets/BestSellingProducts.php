...
class BestSellingProducts extends WP_Widget {
    ...
    public function __construct() {
        $widget_ops = array(
			'classname' => 'woocommerce widget_products sk-best-selling',
			'description' => 'A Widget for displaying Best Selling Products for sk',
		);
        parent::__construct( 'sk-best-selling-widget', 'SK: Best Selling Widget', $widget_ops );
    }
    ...
    public function widget( $args, $instance ) {
        ...
        $r = sk_get_best_selling_products( $no_of_product, $vendor_id, $paged, $hide_outofstock );
    ...
    public function form( $instance ) {
        $title           = isset( $instance['title'] ) ? sanitize_text_field( $instance['title'] ) : __( 'Best Selling Product', 'sk-core' );
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'no_of_product' ) ); ?>"><?php esc_html_e( 'No of Product:', 'sk-core' ); ?></label>
        ...
        <p>
            ...
            <label for="<?php echo esc_attr( $this->get_field_id( 'show_rating' ) ); ?>"><?php esc_html_e( 'Show Product Rating', 'sk-core' ); ?></label>
        </p>
        <p>
            ...
            <label for="<?php echo esc_attr( $this->get_field_id( 'hide_outofstock' ) ); ?>"><?php esc_html_e( 'Hide Out of Stock', 'sk-core' ); ?></label>
        </p>
        <?php
    }
