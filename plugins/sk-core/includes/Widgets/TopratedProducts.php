...
class TopratedProducts extends WP_Widget {
    ...
    public function __construct() {
        parent::__construct(
            'sk-top-rated', __( 'SK: Top Rated Product Widget', 'sk-core' ), // Name
            array(
				'description' => __( 'A Widget for displaying To rated products for sk', 'sk-core' ),
				'classname' => 'woocommerce widget_products sk-top-rated',
            ) // Args
        );
    }
    ...
    public function widget( $args, $instance ) {
        ...
        $r = sk_get_top_rated_products( $no_of_product );
    ...
    public function form( $instance ) {
        if ( isset( $instance['title'] ) ) {
            ...
            $title         = __( 'Top Rated Product', 'sk-core' );
            $no_of_product = 8;
            $show_rating   = 0;
        }
