...
class ProductShipping extends WC_Shipping_Method {
    ...
    public function __construct() {
        $this->id                 = 'sk_product_shipping';
        $this->method_title       = __( 'SK Shipping', 'sk' );
        $this->method_description = __( 'Enable vendors to set shipping cost per product and per country', 'sk' );
    ...
    public function init_form_fields() {
        $this->form_fields = array(
            ...
            'title' => array(
                ...
                'default'       => __( 'Regular Shipping', 'sk' ),
                'desc_tip'      => true,
            ),
            'tax_status' => array(
    ...
    public function calculate_per_seller( $products, $destination_country, $destination_state ) {
        ...
        return apply_filters( 'sk_shipping_calculate_amount', $amount, $price, $products, $destination_country, $destination_state );
    }
}
