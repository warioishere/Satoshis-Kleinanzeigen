...
class ExportController extends Controller {
    ...
    public function get_items_permissions_check( $request ) {
        if ( ! current_user_can( 'manage_woocommerce' ) && ! current_user_can( 'sk_view_reports' ) ) {
            return new \WP_Error( 'woocommerce_rest_cannot_view', __( 'Sorry, you cannot list resources.', 'sk-core' ), array( 'status' => rest_authorization_required_code() ) );
        }
