...
abstract class StatusElement {
    ...
    public function set_children( array $children ): StatusElement {
        if ( ! $this->is_support_children() ) {
            throw new Exception( esc_html__( 'This element does not support child element.', 'sk-core' ) );
        }
    ...
    public function remove( StatusElement $element ): StatusElement {
        if ( ! $this->is_support_children() ) {
            ...
            throw new Exception( esc_html( sprintf( esc_html__( 'Status %s Does not support adding any children.', 'sk-core' ), $this->get_type() ) ) );
        }
    ...
    public function render(): array {
        ...
        return apply_filters( 'sk_status_element_render_' . $this->get_hook_key(), $data, $this );
    }
