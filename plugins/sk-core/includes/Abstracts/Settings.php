...
abstract class Settings extends SettingsElement {
	 ...
	 */
	protected $storage_key = 'sk_settings_';
	...
	public function save( $data ): bool {
		...
		if ( ! $valid ) {
			throw new Exception( esc_html__( 'Settings values must be valid.', 'sk-core' ) );
		}
         ...
         * @param mixed  $data
         */
		do_action( 'sk_settings_after_save_' . $this->storage_key, $data );
