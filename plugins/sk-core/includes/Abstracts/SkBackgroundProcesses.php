...
/**
 * Abstract SK_Background_Processes class
 */
abstract class SkBackgroundProcesses extends \WP_Background_Process {
    ...
    public function schedule_cron_healthcheck( $schedules ) {
        ...
        $schedules[ $this->identifier . '_cron_interval' ] = array(
            ...
            'display'  => sprintf( __( 'Every %d Minutes', 'sk-core' ), $interval ),
        );
     ...
     *
     * Override method to clear sk_background_processes option
     *
     *
     * @return void
     */
    ...
    protected function set_action() {
        $this->action = 'sk_' . md5( static::class );
    }

    /**
     * Dispatch process
     *
     * Calls save and dispatch and update sk_background_processes option
     *
     *
    ...
    public function dispatch_process( $processor_file = null ) {
        ...
        $processes = get_option( 'sk_background_processes', array() );
        $processes[ static::class ] = $processor_file;

        update_option( 'sk_background_processes', $processes, 'no' );

        return $this;
    }

    /**
     * Clean up sk_background_processes option
     *
     *
     * @return $this
     */
