...
class Manager {
    ...
    public function all( $args = [] ) {
        $post_statuses = apply_filters( 'sk_get_product_status', [ 'publish', 'draft', 'pending', 'future' ] );
        ...
        $args = apply_filters( 'sk_all_products_query', $args );
    ...
    public function update( $args = [] ) {
        ...
        if ( empty( $id ) ) {
            return new WP_Error( 'no-id-found', __( 'No product ID found for updating', 'sk-core' ), [ 'status' => 401 ] );
        }
    ...
    public function featured( $args = [] ) {
        ...
        return $this->all( apply_filters( 'sk_featured_products_query', $args ) );
    }
    ...
    public function latest( $args = [] ) {
        ...
        return $this->all( apply_filters( 'sk_latest_products_query', $args ) );
    }
    ...
    public function best_selling( $args = [] ) {
        ...
        return $this->all( apply_filters( 'sk_best_selling_products_query', $args ) );
    }
    ...
    public function top_rated( $args = [] ) {
        ...
        $products = $this->all( apply_filters( 'sk_top_rated_products_query', $args ) );
