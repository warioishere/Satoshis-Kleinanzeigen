...
class Hooks {
    ...
    public function hide_add_to_cart_button( $purchasable, $product ) {
        ...
        if ( 'no' === apply_filters( 'sk_catalog_mode_hide_add_to_cart_button', 'yes', $product, $purchasable ) ) {
            return $purchasable;
        }
    ...
    public function hide_product_price( $price, $product ) {
        ...
        if ( 'no' === apply_filters( 'sk_catalog_mode_hide_product_price', 'yes', $product, $price ) ) {
            return $price;
        }
