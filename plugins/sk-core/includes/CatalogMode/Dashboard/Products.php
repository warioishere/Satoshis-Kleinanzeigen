...
class Products {
    ...
    public function __construct() {
        ...
        add_action( 'sk_product_edit_after_options', [ $this, 'render_product_section' ], 99, 1 );
        // save catalog mode section data
        add_action( 'sk_product_updated', [ $this, 'save_catalog_mode_data' ], 13 );
        add_action( 'sk_new_product_added', [ $this, 'save_catalog_mode_data' ], 13 );
    }
    ...
    public function render_product_section( $product_id ) {
        ...
        $catalog_mode_data = get_post_meta( $product_id, '_sk_catalog_mode', true );
    ...
    public function save_catalog_mode_data( $product_id ) {
        if ( ! isset( $_POST['_sk_catalog_mode_frontend_nonce'] ) || ! wp_verify_nonce( sanitize_key( $_POST['_sk_catalog_mode_frontend_nonce'] ), 'sk_catalog_mode_frontend' ) ) {
            return;
        }
