...
class VendorUtil {
    ...
    public static function get_vendor_default_banner_url(): string {
        ...
        $default_store_banner = SK_CORE_ASSETS . '/images/default-store-banner.png';

        // Retrieve the default banner URL from SK settings, with fallback to the plugin's default banner.
        $banner_url = sk_get_option( 'default_store_banner', 'sk_appearance', $default_store_banner );
         ...
         *
         */
        return apply_filters( 'sk_get_vendor_default_banner_url', $banner_url );
    }
    ...
    public static function get_vendor_default_avatar_url(): string {
        ...
        $default_store_avatar = SK_CORE_ASSETS . '/images/mystery-person.jpg';

        // Retrieve the default avatar URL from SK settings, with fallback to the plugin's default avatar.
        $avatar_url = sk_get_option( 'default_store_profile', 'sk_appearance', $default_store_avatar );
         ...
         *
         */
        return apply_filters( 'sk_get_vendor_default_avatar_url', $avatar_url );
    }
    ...
    public static function get_vendor_id_for_user( int $user_id = 0 ): int {
        ...
        if ( sk_is_user_seller( $user_id, true ) ) {
            return (int) $user_id;
        }
