...
class ExchangeRate {
    ...
    /**
     * Get the current BTC rate for a given fiat currency.
     *
     * @param string $currency  'EUR' or 'CHF'.
     * @return float|WP_Error  Fiat amount per 1 BTC.
     */
     ...
     * @param string $currency  'EUR' or 'CHF'.
     * @return int|WP_Error  Amount in satoshis.
     */
     ...
     * @param string $currency  'EUR' or 'CHF'.
     * @return float|WP_Error  Amount in fiat.
     */
