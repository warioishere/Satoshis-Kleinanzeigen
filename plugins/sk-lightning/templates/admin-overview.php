...
$status = \SK_Lightning\Admin\AdminPage::get_system_status();
$stats  = \SK_Lightning\Admin\AdminPage::get_stats();
...
$page_url = admin_url( 'admin.php?page=sk-lightning' );
