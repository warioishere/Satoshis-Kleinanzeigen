...
?>
    <div class="item">
        <div class="element-title header ">
            ...
            <span class="expand"><?php echo esc_html__('WPC countdown', 'woocommerce-products-slider'); ?></span>
        </div>
...
function wcps_layout_element_wpc_countdown_timer($args)
{
    ...
    ?>
        <div class="<?php echo esc_attr($element_class); ?>"><?php echo wp_kses_post($wooct_action_show_countdown); ?></div>
    <?php
    }
}
