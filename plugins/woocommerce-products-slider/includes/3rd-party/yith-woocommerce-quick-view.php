...
?>
    <div class="item">
        <div class="element-title header ">
            ...
            <span class="expand"><?php echo esc_html__('YITH quick view', 'woocommerce-products-slider'); ?></span>
        </div>
...
?>
    <div class="<?php echo esc_attr($element_class); ?>"><?php echo wp_kses_post(do_shortcode('[yith_quick_view label="' . $label_text . '" product_id="' . $product_id . '" ]'));; ?></div>
<?php
