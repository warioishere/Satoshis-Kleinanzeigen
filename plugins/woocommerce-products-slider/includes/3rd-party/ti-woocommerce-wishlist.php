...
?>
    <div class="item">
        <div class="element-title header ">
            ...
            <span class="expand"><?php echo esc_html__('TI Wishlist', 'woocommerce-products-slider'); ?></span>
        </div>
...
?>
    <div class="<?php echo esc_attr($element_class); ?>"><?php echo do_shortcode('[ti_wishlists_addtowishlist id="' . $product_id . '"]'); ?></div>
<?php
