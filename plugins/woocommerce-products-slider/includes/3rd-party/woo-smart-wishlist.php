...
?>
    <div class="item">
        <div class="element-title header ">
            ...
            <span class="expand"><?php echo esc_html__('WPClever wishlist', 'woocommerce-products-slider'); ?></span>
        </div>
...
?>
    <div class="<?php echo esc_attr($element_class); ?>"><?php echo wp_kses_post(do_shortcode('[woosw id="' . $product_id . '" ]'));; ?></div>
<?php
