...
<div class="wrap">
    ...
    <h2><?php
        ...
        echo esc_html(sprintf(__('%s Settings', 'woocommerce-products-slider'), wcps_plugin_name)); ?></h2>
    <form method="post" action="<?php echo esc_url(str_replace('%7E', '~', wp_unslash($_SERVER['REQUEST_URI']))); ?>">
        ...
        ?>
                <div class="updated notice  is-dismissible">
                    <p><strong><?php esc_html_e('Changes Saved.', 'woocommerce-products-slider'); ?></strong></p>
                </div>
        <?php
            }
        }
        ...
        <div class="settings-tabs vertical has-right-panel" style="display: none">
            ...
            <p class="submit">
                ...
                <input class="button button-primary" type="submit" name="Submit" value="<?php esc_attr_e('Save Changes', 'woocommerce-products-slider'); ?>" />
            </p>
        </div>
    </form>
</div>