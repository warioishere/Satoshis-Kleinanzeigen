...
?>
            <div class="update-nag">
                <?php
                /* translators: %s is YouTUbe video URL */
                echo wp_kses_post(sprintf(__('Data migration required for <b>PickPlugins Product Slider</b> plugin, please <a class="button button-primary" href="%s">click to start</a> migration. Watch this <a target="_blank" href="https://youtu.be/kn3skEwh5t4">video</a>  first', 'woocommerce-products-slider'), $actionurl));
                ?>
            </div>
        <?php
    ...
    public function woocommerce_plugin_missing()
    {
        ...
        ?>
            <div class="update-nag">
                <?php
                /* translators: %s is WooCommerce plugin URL */
                echo wp_kses_post(sprintf(__('<a href="%s">WooCommerce</a> plugin is required to run <b>PickPlugins Product Slider</b>', 'woocommerce-products-slider'), 'https://wordpress.org/plugins/woocommerce/'))
                ?>
            </div>
<?php
